 ...
 */
class WidgetPrayerTimesSmall : AppWidgetProvider() {
    ...
    private fun cancelAlarm(context: Context) {
        val intent = Intent(context, WidgetPrayerTimesSmall::class.java)
    ...
    companion object {
        ...
        fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager,
            ...
            val intentSync = Intent(context, WidgetPrayerTimesSmall::class.java)
            ...
            if(result is Result.Success) {
                ...
                for (i in 0..4) {
                    val prayerTimesView = RemoteViews(context.packageName, R.layout.viewstub_prayertimes_small)
                    context.apply {
                        prayerTimesView.setImageViewBitmap(R.id.prayerType, getFontBitmap(17f, white, QS_MEDIUM, TIME_OF_DAY[i]))
                        prayerTimesView.setImageViewBitmap(R.id.prayerTime, getFontBitmap(19f, white, QS_LIGHT, result.data.prayerTimes[i]))
